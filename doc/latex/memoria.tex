...
% Datos de portada
\title{Frontend aplicación móvil ayuda Esclerósis Múltiple}
\author{\nombre}
\tutor{\nomtutor}
...
\begin{abstract}
Dar solución a personas con \textbf{Esclerósis Múltiple} creando la interfaz visual.
\end{abstract}

\renewcommand*\abstractname{Descriptores}
\begin{abstract}
Palabras separadas por comas que identifiquen el contenido del proyecto Ej: aplicación móvil, android, ayuda, Esclerósis múltiple \ldots
\end{abstract}
